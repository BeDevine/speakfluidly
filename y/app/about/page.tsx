        ...
        <div className="mt-10 grid gap-10 md:grid-cols-[240px_1fr] md:gap-12">
          ...
          <div>
            <p className="text-base leading-relaxed text-ink/75">
              ...
              Switzerland, Poland, China, Vietnam, Mexico, and Malawi, as well as extensively
              online. I've worked with students of every age and background, from teenagers
              to working professionals, helping them build the confidence to actually use
              English in real situations, not just study it.
            </p>
            <p className="mt-4 text-base leading-relaxed text-ink/75">
              ...
              across Cambridge, AP, and IB curricula. That range means I bring a structured,
              practical approach to coaching, focused on what actually helps you improve,
              not just following a textbook.
            </p>
            <p className="mt-4 text-base leading-relaxed text-ink/75">
              Whether you want to speak more confidently while travelling, communicate more
              clearly at work, or prepare for an exam, every session is built around what
              you specifically need — not a one-size-fits-all curriculum.
            </p>
